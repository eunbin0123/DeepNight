...
namespace OculusSampleFramework
{
    public class TrainLocomotive : TrainCarBase
    {
        ...
        private float _speedDiv, currentSpeed;
        ...
        public void StratTrain_(bool Bit)
        {
            _startStopTrainCr = StartCoroutine(StartStopTrain(Bit));
        }
        ...
        private IEnumerator StartStopTrain(bool startTrain)
        {
            ...
            while (Time.time < endTime)
            {
                ...
                //currentSpeed = startSpeed * (1.0f - t) + endSpeed * t;
        ...
        private float PlayEngineSound(EngineSoundState engineSoundState)
        {
            ...
            else
            {
                ...
                int speedIndex = (int)Mathf.Round((currentSpeed - MIN_SPEED) / _speedDiv);
        ...
        {
            //var signedSpeed = _reverse ? -currentSpeed : currentSpeed;
            var signedSpeed = currentSpeed;
        ...
        //    {
        //        currentSpeed = Mathf.Clamp(currentSpeed - _speedDiv, MIN_SPEED, MAX_SPEED);
        //        UpdateSmokeEmissionBasedOnSpeed();
        //        PlayEngineSound(EngineSoundState.AccelerateOrSetProperSpeed);
        //    }
        //}
        ...
        private void UpdateSmokeEmissionBasedOnSpeed()
        {
            ...
            mainModule.maxParticles = (int)Mathf.Lerp(_standardMaxParticles, _standardMaxParticles * MAX_PARTICLES_MULTIPLIER,
                currentSpeed / (MAX_SPEED - MIN_SPEED));
        }
        ...
        public void OnTriggerStay(Collider other)
        {
            ...
            if (other.gameObject.tag == "Train_Destination")
            {
                
                GM.Train_Destination = true;
